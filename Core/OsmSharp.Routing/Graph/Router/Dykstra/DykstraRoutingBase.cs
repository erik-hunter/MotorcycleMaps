...
namespace OsmSharp.Routing.Graph.Router.Dykstra
{
        ...
        where EdgeData : IDynamicGraphEdgeData
    {
        ...
        /// <summary>
        /// Empty delegate for simple events.
        /// </summary>
        public delegate void RoutingDelegate();

        /// <summary>
        /// The routing started event.
        /// </summary>
        public event RoutingDelegate RoutingStarted;

        /// <summary>
        /// Invokes the routing started event.
        /// </summary>
        protected void InvokeRoutingStarted()
        {
            if (this.RoutingStarted != null)
            {
                this.RoutingStarted();
            }
        }
        ...
        /// <summary>
        /// The routing stopped event.
        /// </summary>
        public event RoutingDelegate RoutingStopped;

        /// <summary>
        /// Invokes the routing stopped event.
        /// </summary>
        protected void InvokeRoutingStopped()
        {
            if (this.RoutingStopped != null)
            {
                this.RoutingStopped();
            }
        }
        ...
        /// <summary>
        /// Delegate for selected vertices.
        /// </summary>
        ...
        public delegate void RoutingVertexSelectedDelegate(long? from, float fromLatitude, float fromLongitude, 
            long vertex, float latitude, float longitude);

        /// <summary>
        /// The routing vertex selected event.
        /// </summary>
        public event RoutingVertexSelectedDelegate RoutingVertexSelected;

        /// <summary>
        /// Invokes the routing vertex selected event.
        /// </summary>
        /// <param name="fromLongitude"></param>
        /// <param name="vertex"></param>
        /// <param name="latitude"></param>
        ...
        /// <param name="from"></param>
        /// <param name="fromLatitude"></param>
        protected void InvokeRoutingVertexSelected(long? from, float fromLatitude, float fromLongitude,
            long vertex, float latitude, float longitude)
        {
            if (this.RoutingVertexSelected != null)
            {
                this.RoutingVertexSelected(from, fromLatitude, fromLongitude, vertex, latitude, longitude);
            }
        }

        /// <summary>
        /// Returns true if the routing vertex selected event needs to be invoked.
        /// </summary>
        /// <returns></returns>
        protected bool InvokeRoutingVertexSelectedRequired()
        {
            return this.RoutingVertexSelected != null;
        }
