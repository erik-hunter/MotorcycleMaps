...
namespace OsmSharp.Routing.Osm.Interpreter.Edge
{
    ...
    public class EdgeInterpreter : IEdgeInterpreter
    {
        ...
        public EdgeInterpreter()
        {
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("tertiary_link", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, true);
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("secondary_link", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, true);
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("primary_link", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, true);
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("trunk_link", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, true);
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("service", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, false);
            ...
            highway_dic = new Dictionary<VehicleEnum, bool>();
            _access_restrictions.Add("track", highway_dic);
            highway_dic.Add(VehicleEnum.Pedestrian, true);
            highway_dic.Add(VehicleEnum.Bicycle, true);
            highway_dic.Add(VehicleEnum.Moped, true);
            highway_dic.Add(VehicleEnum.MotorCycle, true);
        ...
        public bool? IsOneWay(IDictionary<string, string> tags, VehicleEnum vehicle)
        {
            ...
            {
                if (String.Equals(oneway, "yes", StringComparison.InvariantCultureIgnoreCase)
                    || String.Equals(oneway, "true", StringComparison.InvariantCultureIgnoreCase))
                {
                    return true;
                }
                if (!String.Equals(oneway, "no", StringComparison.InvariantCultureIgnoreCase))
                { // oneway=no is sometimes use for bidirectional roads.
                    return false;
                }
            }
            string junction;
        ...
        public KilometerPerHour MaxSpeed(VehicleEnum vehicle, IDictionary<string, string> tags)
        {
                ...
                switch (highway_type)
                {
                    ...
                    case "living_street":
                        switch (vehicle)
                        {
                            ...
                            case VehicleEnum.BigTruck:
                            case VehicleEnum.SmallTruck:
            ...
            // get max-speed tag if any and max-out the set speed.
            double? max_speed_value = tags.GetNumericValue("maxspeed"); // TODO: take into account the mph km/h problem?!
            if (max_speed_value.HasValue && max_speed_value.Value < speed.Value)
            { 
                speed = max_speed_value.Value;
            }
