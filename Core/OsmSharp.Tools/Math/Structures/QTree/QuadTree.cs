...
namespace OsmSharp.Tools.Math.Structures.QTree
{
    ...
    public class QuadTree<TPointType, TDataType> : ILocatedObjectIndex<TPointType, TDataType> where TPointType : PointF2D
    {
        ...
        /// <returns></returns>
        public QuadTree(int dept, GenericRectangleF2D<TPointType> bounds)
        {
        ...
        /// <returns></returns>
        public QuadTree(int dept, double min_0, double min_1, double max_0, double max_1)
        {
        ...
        {
            QuadTreeNode leaf_node = GetOrCreateAt(location);
        ...
        private QuadTreeNode GetOrCreateAt(TPointType point)
        {
            if (_root == null)
            {
                ...
                _root = new QuadTreeNode(0, point[0] - 0.01, point[1] - 0.01, point[0] + 0.01, point[1] + 0.01);
            }
            ...
            if (!_root.IsInsideBox(point))
            {
                ...
                if (point[0] < _root.Min0)
                {
                    ...
                    {
                        // expand towards the minimum.
                        _root = new QuadTreeNode(true, true, _root);

                        // recursive call to the quad tree.
                        return GetOrCreateAt(point);
                    }
                    // expand towards the maximum.
                    _root = new QuadTreeNode(true, false, _root);
                ...
                if (point[0] > _root.Max0)
                {
                    ...
                    {
                        // expand towards the minimum.
                        _root = new QuadTreeNode(false, true, _root);
                    ...
                    // expand towards the maximum.
                    _root = new QuadTreeNode(false, false, _root);
        ...
        private class QuadTreeNode
        {
            ...
            /// </summary>
            private readonly double _middle_0;

            /// <summary>
            ///     The middle of this node in dimension 1.
            /// </summary>
            private readonly double _middle_1;
            ...
            public QuadTreeNode(int dept, GenericRectangleF2D<TPointType> bounds)
            {
                ...
                _bounds = new RectangleF2D(new PointF2D(bounds.Max[0], bounds.Max[1]), new PointF2D(bounds.Min[0], bounds.Min[1]));
            ...
            public QuadTreeNode(int dept, double min_0, double min_1, double max_0, double max_1)
            {
                ...
                _bounds = new RectangleF2D(new PointF2D(max_0, max_1), new PointF2D(min_0, min_1));
            ...
            public QuadTreeNode(bool min0, bool min1, QuadTreeNode node)
            {
                _depth = node.Depth + 1;
            ...
            public QuadTreeNode GetOrCreateAt(TPointType point)
            {
                ...
                if (_middle_0 > point[0])
                {
                    ...
                    if (_middle_1 > point[1])
                    {
                        ...
                        if (_min_min == null)
                            _min_min = new QuadTreeNode(_depth - 1, Min0, Min1, _middle_0, _middle_1);
                        return _min_min.GetOrCreateAt(point);
                    }
                    
                    // large side of dimension 1.
                    if (_min_max == null)
                        _min_max = new QuadTreeNode(_depth - 1, Min0, _middle_1, _middle_0, Max1);
                ...
                if (_middle_1 > point[1])
                {
                    // small side of dimension 1.
                    if (_max_min == null)
                        _max_min = new QuadTreeNode(_depth - 1, _middle_0, Min1, Max0, _middle_1);
                    return _max_min.GetOrCreateAt(point);
                }
                
                // large side of dimension 1.
                if (_max_max == null)
                    _max_max = new QuadTreeNode(_depth - 1, _middle_0, _middle_1, Max0, Max1);
            ...
            public void AddInsideAtNode(IList<TDataType> data, QuadTreeNode node, GenericRectangleF2D<TPointType> box)
            {
                if (box.Overlaps(_bounds))
                {
                    ...
                    {
                        foreach (var data_pair in _data)
                        {
